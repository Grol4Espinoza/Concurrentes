...
*/
	volatile int[][][] lista_de_imagenes = null;
    ...
    public static int paintItBlack(int argb, boolean _alpha_) {
        ...
        //System.out.println("ANNN: "+annn+" ALPHA: "+alpha+" N: "+n+" N<<8: "+(n<<8)+" N<<16: "+(n<<16));	
        return annn;
    }

    public static int[][] toGrayScale(int[][] matrix, boolean _alpha_){
